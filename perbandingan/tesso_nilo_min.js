! function() {
    ...
    function i(b, c, d) {
        ...
        var g = b.selectAll("path.datamaps-arc").data(c, JSON.stringify),
            h = n.geo.path().projection(e.projection);
        ...
        p = {
            ...
            geographyConfig: {
                ...
                popupTemplate: function(a) {
                    return '<div class="hoverinfo"><strong>Loss Year : '+ a.properties.YEAR +'</strong><br>Area : ' + a.properties.HA + " Ha</div>"
                },
                popupOnHover: !0,
                highlightOnHover: !0,
    ...
    m.prototype.resize = function() {
        var a = this,
            b = a.options;
        if (b.responsive) {
            var c = "-webkit-transform" in document.body.style ? "-webkit-" : "-moz-transform" in document.body.style ? "-moz-" : "-ms-transform" in document.body.style ? "-ms-" : "",
                d = b.element.clientWidth,
                e = n.select(b.element).select("svg").attr("data-width");
        ...
        var b = this,
            c = b.options,
            d = c.setProjection.apply(b, [c.element, c]);
        ...
        for (var c in a)
            ...
            if (a.hasOwnProperty(c)) {
                var d, e = a[c];
                if (!c) continue;
                d = "string" == typeof e ? e : "string" == typeof e.color ? e.color : this.options.fills[e.fillKey], e === Object(e) && (this.options.data[c] = l(e, this.options.data[c] || {}), this.svg.select("." + a).attr("data-info", JSON.stringify(this.options.data[c]))), b.selectAll("." + c).transition().style("fill", d)
            }
